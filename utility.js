...
module.exports.successMessage = (item) => { console.log(GREEN_COLOR_TERMINAL, `✔ ${item} successfully loaded.`, RESET_COLOR_TERMINAL) };
module.exports.errorMessage = (item) => { return `❌ ${item} not loaded.` }; // First letter should be capitalized.
